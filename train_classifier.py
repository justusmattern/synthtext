...
def run(model_name='distilbert-base-uncased', epochs = 20, save_dir = 'trained_classifiers'):
    ...
    for epoch in range(epochs):
        ...
        for x, y in train_loader:
            ...
            correct_predictions = torch.sum(preds == y.long())
        ...
        for x, y, meta in val_loader:
            ...
            val_true.append(y[0].item())
            val_meta.append(meta[0].item())
        ...
        for x, y, meta in test_loader:
            ...
            test_preds.append(preds[0].item())
            test_true.append(y[0].item())
            test_meta.append(meta[0].item())
